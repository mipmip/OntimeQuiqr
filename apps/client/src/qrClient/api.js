...
export class API {
  ...
  getFilteredHugoVersions(){
    return this.fakePromise("getFilteredHugoVersions",["v0.100.2"]);
  }

  getConfigurations(options){
    return this.fakePromise('getConfigurations',{sites:[]});
  }

  stopHugoServer(){
    return this.fakePromise('stopHugoServer');
  }

  saveConfPrefKey(prefKey, prefValue){
    return this.fakePromise('saveConfPrefKey');
